<template>
    <div class="fixed top-0 right-0 p-4 z-50 space-y-2">
      <div 
        v-for="notification in notifications" 
        :key="notification.id"
        class="p-4 rounded-md shadow-lg max-w-md transform transition-all duration-300 ease-in-out"
  ...
  import { useNotification } from '@/composables/users/use-notification'
