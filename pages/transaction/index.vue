<template>
  <div class="min-h-screen bg-white">
    <!-- Header -->
    <div class="flex items-center px-4 py-3 border-b border-gray-300 mx-8">
    ...
    <div class="p-4 pb-32">
      ...
      <div v-else>
        <div
          ...
          :key="index"
          class="mb-4 border border-gray-200 rounded-[10px] p-4"
        >
          <!-- Transaction Header -->
    ...
    <div
      class="fixed bottom-20 left-1/2 transform -translate-x-1/2 bg-white border-t shadow-sm max-w-[425px] w-full"
    >
      <button
    ...
    <Transition name="slide-up">
      <div v-if="showCancellationModal" class="fixed inset-0 z-50">
        ...
        <!-- Modal Content -->
        <div
          class="absolute bottom-0 left-0 right-0 bg-white rounded-t-xl max-h-[90vh] overflow-auto"
        >
